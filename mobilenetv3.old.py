...
class MobileNetV3_Large(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.bneck = nn.Sequential(
            ...
            Block(5, 24, 72, 40, nn.ReLU(inplace=True), SeModule(40), 2, 0.5),
            Block(5, 40, 120, 40, nn.ReLU(inplace=True), SeModule(40), 1, 0.75),
            Block(5, 40, 120, 40, nn.ReLU(inplace=True), SeModule(40), 1, 0),
            Block(3, 40, 240, 80, hswish(), None, 2, 0.5),
            Block(3, 80, 200, 80, hswish(), None, 1, 0.5),
            Block(3, 80, 184, 80, hswish(), None, 1, 0.5),
            Block(3, 80, 184, 80, hswish(), None, 1, 0),
            Block(3, 80, 480, 112, hswish(), SeModule(112), 1, 0.5),
            Block(3, 112, 672, 112, hswish(), SeModule(112), 1, 0.75),
            Block(5, 112, 672, 160, hswish(), SeModule(160), 1, 0.75),
